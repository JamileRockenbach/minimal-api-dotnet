...
Criar uma API de registro de veículos

Implementar autenticação e autorização com JWT

Utilizar o Swagger para documentação dos endpoints

Adicionar testes e boas práticas para garantir confiabilidade
...
### ⚙️ Funcionalidades Principais
 ...
 - Organização em camadas (Domínio, Infraestrutura, API)
...
Aprender sobre JWT, controle de acesso e segurança em APIs

Utilizar o Swagger para documentar e testar endpoints

Entender a importância dos testes e da organização em camadas

Explorar boas práticas de estruturação de projetos back-end
